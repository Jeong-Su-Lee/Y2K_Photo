...
QT_MOC_LITERAL(3, 24, 12) // "const uchar*"
    ...
    "CameraThread\0send_data\0\0const uchar*"
};
...
void CameraThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CameraThread::*)(const uchar * , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraThread::send_data)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CameraThread::send_data(const uchar * _t1, int _t2, int _t3)
{

/****************************************************************************
** Meta object code from reading C++ file 'udp_listener_thread.h'
**
...
#include <memory>
#include "../camera/udp_listener_thread.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'udp_listener_thread.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 18, 16), // "captureRequested"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "UDPListenerThread\0captureRequested\0"
};
...
void UDPListenerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<UDPListenerThread *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (UDPListenerThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UDPListenerThread::captureRequested)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject UDPListenerThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_UDPListenerThread.data,
    qt_meta_data_UDPListenerThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void UDPListenerThread::captureRequested()
{
